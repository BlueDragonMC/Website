...
export default function Footer() {
    return (
        <footer
            className={
                "min-h-64 z-40 relative bg-neutral-300 dark:bg-gray-700 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 grid-rows-2 p-4 items-center mt-36"
            }
        >
            {/* First row */}
            <div>
            ...
            <div>
                <Link href="https://discord.gg/3gvSPdW" className="mr-5">
                    <Discord className="inline fill-black dark:fill-white h-8" />
                </Link>
                <Link href="https://github.com/BlueDragonMC" className="mr-5">
                    <GitHub className="inline fill-black dark:fill-white h-8" />
                </Link>
                <Link href="https://twitter.com/BDMCNetwork">
                    <Twitter className="inline fill-black dark:fill-white h-8" />
                </Link>
            </div>
            <div className="md:text-right lg:col-span-2">
                <span>&copy; 2023 BlueDragonMC</span>
                <br />
                <Link href="/page/changelog" className="underline font-medium">
                    Changelog
                </Link>{" "}
                &middot;{" "}
                <Link href="/page/rules" className="underline font-medium">
                    Server Rules
                </Link>{" "}
                &middot;{" "}
