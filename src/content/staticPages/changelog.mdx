...
<p class="my-4"><a href="/rss/changelog/feed.xml" target="_blank"><svg aria-hidden="true" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="mr-1 inline-block h-4 w-4 overflow-hidden align-[-0.125em]"><path fill="currentColor" d="M96 128c0-17.7 14.3-32 32-32c229.8 0 416 186.2 416 416c0 17.7-14.3 32-32 32s-32-14.3-32-32c0-194.4-157.6-352-352-352c-17.7 0-32-14.3-32-32m0 352c0-35.3 28.7-64 64-64s64 28.7 64 64s-28.7 64-64 64s-64-28.7-64-64m32-256c159.1 0 288 128.9 288 288c0 17.7-14.3 32-32 32s-32-14.3-32-32c0-123.7-100.3-224-224-224c-17.7 0-32-14.3-32-32s14.3-32 32-32"/></svg>RSS</a> &middot; <a href="/rss/changelog/atom.xml" target="_blank">Atom</a> &middot; <a href="/rss/changelog/feed.json" target="_blank">JSON</a></p>

## 2026-09-08

#### Server

- Fixed several bugs with parties, including parties losing their leader and keeping players who left

#### Lobby

- Re-enabled boss bars in the lobby

## 2026-09-05

#### Server

- Fixed a bug where projectiles failed to spawn

## 2026-08-19

#### Lobby

- Fixed lobby titles not appearing when players first joined

#### Infinijump

- Fixed the "sending you to the lobby" countdown not resetting when a player left the game

## 2026-08-15

#### Lobby

- Fixed a bug with the tic-tac-toe minigame

## 2026-08-02

#### Creative

- Added a world generator selection menu, including a new Vanilla Minecraft world generator

#### HueHunters

- Fixed inconsistent x-ray behavior on custom maps

## 2026-07-26

#### Creative

- Added x-ray color configuration to HueHunters map settings
...
- Added a new game: **Creative**! Build your own maps using a variety of tools, then save them and play them in supported games.
  - Creative is only available to a small group of players while we test it.
- Added a "Create New Map" button to the Lobby

## 2026-06-07

#### Server

- Added player heads to chat messages
- Fixed scoreboards not appearing when players first joined a game

## 2026-06-03

#### Server

- Reworked the queue system, which is now faster and more reliable and handles rare edge cases better

## 2026-05-06

#### WackyMaze

- Added knockback stick upgrade powerups
  - Collect a powerup around the map to increase your stick's knockback level by 1

## 2026-05-02

#### Dominate

- Added names for capture points

## 2026-04-25

#### Server

- Added team colors to player names in the tablist

#### WackyMaze

- Reworked WackyMaze: knockback is reduced, the map now decays over time, and players can double jump

#### Dominate

- Added locator bar support showing the location of capture points
- Fixed a bug with the swimmer kit where the player didn't actually speed up in water

#### HueHunters

- Fixed a bug where hiders could hurt themselves when attacking their own disguised block

#### Lobby

- Removed the player's rank from the lobby sidebar

## 2026-04-12

#### Server

- Fixed an issue where some coin awards weren't granted when multiple awards were processed at the same time
- Added trapdoor support to all games that support doors

#### Paintbrawl

- Added coin awards for points earned during a game

#### WackyMaze

- Added coin awards for kills and whacks

## 2026-04-04

#### Lobby

- Made menu navigation support nesting so back buttons return to the previous menu

## 2026-03-28

#### HueHunters

- Renamed seeker items to make them clearer (e.g., "Reveal Red hiders")

#### Dominate

- Throwing TNT now uses Minecraft's item cooldown indicator in the hotbar
